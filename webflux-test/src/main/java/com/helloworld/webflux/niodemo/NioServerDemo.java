...
public class NioServerDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        NioClient httpClient = new NioClient("127.0.0.1", 7080, 200);
        ...
        NioServer server = new NioServer(8080, (reqWrapper) -> {
            ...
            httpClient.sendMsg(reqData, (resp) -> {
                // 来之客户端的线程，它把远程nodejs服务端的数据，写入到SocketChannel
        ...
        // 由主线程轮序即可，也可以新起一个线程去处理，可以自行测试。注意当前eventPoll() 所在的线程是main。eventPoll方法不支持多线程执行，注意并发安全
        server.eventPoll();
    }
}
